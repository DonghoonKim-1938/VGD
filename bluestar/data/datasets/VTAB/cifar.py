...
from bluestar.data.datasets.base_dataset import register_dataset
...
class CifarData(base.ImageTfdsData):
  ...
  def __init__(self, num_classes=100, data_dir=None, train_split_percent=None):
